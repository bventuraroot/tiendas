...
switch(type){
    case 'gravada':
        ...
        if(typedoc=='8'){
            ...
            $('#rentarete').val(parseFloat(0).toFixed(2));
        }
...
function aviablenext_wizard(idcompany) {
    $("#step1").prop("disabled", false);
}

function getclientbycompanyurl_wizard(idcompany) {
    $.ajax({
                        ...
                        case "step-document-type":
                            ...
                            if (typedocument && typedocument !== '') {
                                ...
                                if (window.hasAutoSelectedCompany && window.autoSelectedCompanyId) {
                                    ...
                                    getclientbycompanyurl_wizard(window.autoSelectedCompanyId);
                                    // Simular aviablenext para empresa auto-seleccionada
                                    aviablenext_wizard(window.autoSelectedCompanyId);
                                    // Crear correlativo
                                    createcorrsale(typedocument);
