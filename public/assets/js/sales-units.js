...
$(document).ready(function() {
    ...
    function loadUnitsDropdown(units) {
        ...
        if (units && units.length > 0) {
            ...
            if (currentProductData && currentProductData.product && (currentProductData.product.pastillas_per_blister || currentProductData.product.blisters_per_caja)) {
                // Para productos farmacéuticos, cargar solo unidades farmacéuticas
                allowedUnitCodes = ['PASTILLA', 'BLISTER', 'CAJA'];
            } else if (currentProductData && currentProductData.product && currentProductData.product.sale_type) {
