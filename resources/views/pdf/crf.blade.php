                ...
                <tr>
                    <td width="490px">
                        <table width="100%" border="0">
                            ...
                            <tr>
                                <td>{{ $json["json_enviado"]["extension"]["nombEntrega"] ?? $usuario->name }}</td>
                                <td>{{ $json["json_enviado"]["extension"]["docuEntrega"] ?? $usuario->nit }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>{{ $json["json_enviado"]["extension"]["nombRecibe"] ?? '' }}</td>
                                <td>{{ $json["json_enviado"]["extension"]["docuRecibe"] ?? '' }}</td>
                            </tr>
                            <tr>
                    ...
                    <td style="border:1px solid #000;" width="230px">
                        <!--- Totales-->
                        <table style="border-spacing: 0 0;" border="0">
                            <tr>
