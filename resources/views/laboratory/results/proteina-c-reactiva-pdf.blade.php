...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Proteína C Reactiva (PCR)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            @php
                ...
                $unidad = $result ? ($result->unidad_medida ?? 'mg/L') : 'mg/L';
                $valorReferencia = $result ? $result->valor_referencia : ($valoresReferencia['valores_referencia']['rango'] ?? 'Menor o Igual a 6 mg/L');
            @endphp
            
            <tr>
                <td class="exam-name">Proteína C Reactiva (PCR):</td>
