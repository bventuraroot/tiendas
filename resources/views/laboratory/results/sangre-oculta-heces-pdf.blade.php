...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Sangre Oculta en Heces' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">{{ $valoresReferencia['categoria'] ?? 'COPROLOGIA' }}</td>
                <td></td>
                <td></td>
            </tr>
            @php
            ...
            <tr>
                <td class="exam-name">Sangre Oculta en Heces:</td>
