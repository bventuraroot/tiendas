...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Insulina B' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
    ...
    <table class="results-table">
        ...
        <tbody>
            @php
                ...
                $unidad = $result ? ($result->unidad_medida ?? 'ulU/ml') : 'ulU/ml';
                $valorReferencia = $result ? $result->valor_referencia : ($valoresReferencia['valores_referencia']['rango'] ?? '2.44 - 24.43 ulU/ml');
            @endphp

            <tr>
                <td class="exam-name">INSULINA B</td>
