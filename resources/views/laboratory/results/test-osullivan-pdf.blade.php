...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Test de O\'Sullivan' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    @php
        ...
        $valRef = config('lab_exam_templates.test_osullivan.valores_referencia', []);
        ...
        $notaDextrosa = $valRef['nota_dextrosa'] ?? 'Se Administro 50 Gramos de Dextrosa.';
    @endphp
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            <tr>
                <td class="exam-subtitle" colspan="3" style="padding-top: 1%; padding-bottom: 1%;">Test de O'Sullivan</td>
            </tr>
            @foreach($params as $p)
                @php
