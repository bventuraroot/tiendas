...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Virus Inmunodeficiencia Humana (HIV)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            <tr>
                <td class="exam-name">{{ $exam->nombre ?? 'Virus Inmunodeficiencia Humana (HIV)' }}:</td>
                ...
                <td class="reference-range">
                    <!-- Rango de referencia vacío para VIH -->
                </td>
            </tr>
