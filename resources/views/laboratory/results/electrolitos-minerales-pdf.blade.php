...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Electrolitos / Minerales' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    @php
        $valRefConfig = config('lab_exam_templates.electrolitos_minerales.valores_referencia', []);
        $resultsByParam = $results->keyBy('parametro');

        $params = [
            ['key' => 'cloro', 'label' => 'Cloro', 'unidad' => 'mEq/L'],
            ['key' => 'sodio', 'label' => 'Sodio', 'unidad' => 'mEq/L'],
            ['key' => 'potasio', 'label' => 'Potasio', 'unidad' => 'mEq/L'],
            ['key' => 'magnesio', 'label' => 'Magnesio', 'unidad' => 'mEq/L'],
            ['key' => 'calcio', 'label' => 'Calcio', 'unidad' => 'mEq/L'],
            ['key' => 'fosforo', 'label' => 'Fósforo', 'unidad' => ''],
        ];
    @endphp
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category" colspan="3" style="padding-top: 1%; padding-bottom: 1%;">ELECTROLITOS / MINERALES</td>
            </tr>
            @foreach($params as $p)
                @php
