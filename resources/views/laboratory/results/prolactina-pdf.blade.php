...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Prolactina (PRL)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            <tr>
                <td class="exam-name">Prolactina (PRL):</td>
                <td style="text-align: center;">
                    @if($result)
                        {{ $resultValue }} {{ $unidad }}
                    @endif
                </td>
                <td style="text-align: center;" class="reference-range">{{ $valorReferencia }}</td>
            </tr>
        </tbody>
    </table>
