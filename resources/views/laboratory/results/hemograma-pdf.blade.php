...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Hemograma' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    @php
        $valRefConfig = config('lab_exam_templates.hemograma.valores_referencia', []);
        $resultsByParam = $results->keyBy('parametro');

        $params = [
            ['key' => 'globulos_blancos', 'label' => 'Recuento de Glóbulos Blancos', 'unidad' => '/ uL'],
            ['key' => 'neutrofilos', 'label' => 'Neutrófilos %', 'unidad' => '%'],
            ['key' => 'eosinofilos', 'label' => 'Eosinófilos %', 'unidad' => '%'],
            ['key' => 'basofilos', 'label' => 'Basófilos %', 'unidad' => '%'],
            ['key' => 'linfocitos', 'label' => 'Linfocitos %', 'unidad' => '%'],
            ['key' => 'monocitos', 'label' => 'Monocitos %', 'unidad' => '%'],
            ['key' => 'globulos_rojos', 'label' => 'Recuento de Glóbulos Rojos', 'unidad' => 'x 10^6 / uL'],
            ['key' => 'hematocrito', 'label' => 'Hematocrito', 'unidad' => '%'],
            ['key' => 'hemoglobina', 'label' => 'Hemoglobina', 'unidad' => 'g/dL'],
            ['key' => 'vcm', 'label' => 'VCM', 'unidad' => 'fL'],
            ['key' => 'chcm', 'label' => 'CHCM', 'unidad' => 'g/dL'],
            ['key' => 'hcm', 'label' => 'HCM', 'unidad' => 'pg'],
            ['key' => 'plaquetas', 'label' => 'Plaquetas', 'unidad' => '/uL'],
        ];
    @endphp
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category" colspan="3" style="padding-top: 1%; padding-bottom: 1%;">HEMATOLOGIA COMPLETA (HEMOGRAMA)</td>
            </tr>
            @foreach($params as $p)
                @php
                    ...
                    if (!$r && $resultsByParam->isNotEmpty()) {
                        ...
                        foreach ($resultsByParam as $key => $result) {
                            ...
                            if (stripos($keyLower, $p['key']) !== false) {
                                $r = $result;
                                break;
                            }
                        }
