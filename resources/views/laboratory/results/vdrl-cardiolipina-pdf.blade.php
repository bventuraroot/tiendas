...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'V.D.R.L. (Cardiolipina)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">INMUNOLOGIA INFECCIOSAS</td>
                <td></td>
                <td></td>
            </tr>
            @php
                $result = $results->firstWhere('parametro', 'V.D.R.L. (Cardiolipina)');
                $resultadoValue = $result ? $result->resultado : '';
            @endphp
            
            <tr>
                <td class="exam-name">V.D.R.L. (Cardiolipina):</td>
                ...
                <td class="reference-range">
                    <!-- Rango de referencia vacío según la imagen -->
                </td>
            </tr>
        </tbody>
    </table>
