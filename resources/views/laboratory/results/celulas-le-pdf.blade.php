...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Células L.E' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">{{ $valoresReferencia['categoria'] ?? 'INMUNOHEMTOLOGIA' }}</td>
                <td></td>
                <td></td>
            </tr>
            @php
                ...
                $resultadoDisplay = '';
                if (stripos($resultValue, 'negativo') !== false) {
                    $resultadoDisplay = 'Negativo';
                } elseif (stripos($resultValue, 'positivo') !== false) {
            ...
            <tr>
                ...
                <td class="reference-range">
                    <!-- Sin rango de referencia visible según el documento -->
                </td>
            </tr>
        </tbody>
    </table>
