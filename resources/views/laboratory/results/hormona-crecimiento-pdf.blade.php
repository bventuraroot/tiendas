...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Hormona del Crecimiento Pre-Ejercicio (HGh)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            @php
                ...
                $valorReferencia = $result ? $result->valor_referencia : ($valoresReferencia['valores_referencia']['rango'] ?? '0.06 a 5.00 ng/mL');
            @endphp

            <tr>
                <td class="exam-name">Hormona del Crecimiento Pre-Ejercicio (HGh):</td>
