...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Factor Reumatoideo (FR)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">SEROLOGIA</td>
                <td></td>
                <td></td>
            </tr>
            @php
            ...
            <tr>
                <td class="exam-name">Factor Reumatoideo (FR) :</td>
    ...
    <div class="instructions-section">
        ...
        <div class="formula-example">
            EJEMPLO 1/16<br>
            CONCENTRACIÓN DE FR = 8X16= <strong>128 UI/mL</strong>
        </div>
        <div class="spacer"></div>
        <div>Ver incerto</div>
    </div>
