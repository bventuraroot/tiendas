...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'COPROCULTIVO' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    @php
        $valRefConfig = config('lab_exam_templates.coprocultivo.valores_referencia', []);
        ...
        $params = [
            ...
            ['key' => 'tipo_muestra', 'label' => 'Tipo de Muestra', 'unidad' => ''],
        ];
    @endphp
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category" colspan="3" style="padding-top: 1%; padding-bottom: 1%;">COPROCULTIVO</td>
            </tr>
            @foreach($params as $p)
                @php
