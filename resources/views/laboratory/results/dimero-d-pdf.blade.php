...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Dimero D' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
        ...
        .reference-range {
            background-color: #c6efce; /* verde suave para el rango */
        }
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">COAGULACIÓN</td>
                <td></td>
                <td></td>
            </tr>
            @php
            ...
            <tr>
                <td class="exam-name">Dimero D:</td>
