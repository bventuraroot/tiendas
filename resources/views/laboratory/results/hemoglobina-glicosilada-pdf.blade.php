...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Hemoglobina Glicosilada A1c' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">{{ $valoresReferencia['categoria'] ?? 'PRUEBAS METABOLICAS' }}</td>
                <td></td>
                <td></td>
            </tr>
            @php
                ...
                $unidad = $result ? ($result->unidad_medida ?? '%') : '%';
            ...
            <tr>
                <td class="exam-name">Hemoglobina Glicosilada A1c:</td>
