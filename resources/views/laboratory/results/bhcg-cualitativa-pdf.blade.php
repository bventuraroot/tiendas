...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'B-hCG Cualitativa en Sangre' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            @php
                ...
                $valorReferencia = $result ? $result->valor_referencia : ($valoresReferencia['valores_referencia']['normal']['rango'] ?? 'Negativo');
            @endphp
            
            <tr>
                <td class="exam-name">B-hCG Cualitativa en Sangre:</td>
