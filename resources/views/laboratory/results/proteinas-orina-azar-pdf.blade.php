...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Proteinas en Orina al Azar' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">{{ $valoresReferencia['categoria'] ?? 'UROLOGIA' }}</td>
                <td></td>
                <td></td>
            </tr>
            @php
                ...
                $unidad = $result ? ($result->unidad_medida ?? 'mg/dL') : 'mg/dL';
                $valorReferencia = $result ? $result->valor_referencia : ($valoresReferencia['valores_referencia']['rango'] ?? 'Hasta: 15 mg/dL');
            @endphp
            
            <tr>
                <td class="exam-name">Proteinas en Orina al Azar:</td>
