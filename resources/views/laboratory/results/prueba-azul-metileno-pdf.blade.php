...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">{{ $valoresReferencia['categoria'] ?? 'COPROLOGÍA' }}</td>
                <td></td>
                <td></td>
            </tr>
            @php
                // Obtener los dos resultados
                $resultadoPolimorfonucleares = $results->firstWhere('parametro', 'Leucocitos Polimorfonucleares');
                $resultadoMononucleares = $results->firstWhere('parametro', 'Leucocitos Mononucleares');
            @endphp
            
            <tr>
                <td class="exam-name">Prueba de Azul de Metileno (P.A.M.)</td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td class="exam-name">Leucocitos Polimorfonucleares:</td>
                <td style="text-align: center;">
                    @if($resultadoPolimorfonucleares)
                        {{ $resultadoPolimorfonucleares->resultado }} {{ $resultadoPolimorfonucleares->unidad_medida ?? '%' }}
                    @endif
                </td>
                <td class="reference-range">{{ $resultadoPolimorfonucleares->valor_referencia ?? '' }}</td>
            </tr>
            <tr>
                <td class="exam-name">Leucocitos Mononucleares:</td>
                <td style="text-align: center;">
                    @if($resultadoMononucleares)
                        {{ $resultadoMononucleares->resultado }} {{ $resultadoMononucleares->unidad_medida ?? '%' }}
                    @endif
                </td>
                <td class="reference-range">{{ $resultadoMononucleares->valor_referencia ?? '' }}</td>
            </tr>
        </tbody>
    </table>
