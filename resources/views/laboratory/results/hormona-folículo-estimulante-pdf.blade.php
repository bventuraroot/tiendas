...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Hormona Folículo Estimulante (FSH)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            @php
                ...
                $unidad = $result ? ($result->unidad_medida ?? 'mUI/mL') : 'mUI/mL';
            ...
            <tr>
                <td class="exam-name">Hormona Folículo Estimulante (FSH):</td>
