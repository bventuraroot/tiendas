...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'CA 19-9 Páncreas Gastrointestinales' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            @php
                ...
                $unit = $valoresReferencia['unidad_medida'] ?? ($result && $result->unidad_medida ? $result->unidad_medida : 'U/mL');
            @endphp
                ...
                <td class="reference-range">
                    @if($valoresReferencia)
                        @if(isset($valoresReferencia['normal']))
                            {{ $valoresReferencia['normal']['rango'] ?? '0.0 a 39.0 U/mL' }}
                        @else
                            0.0 a 39.0 U/mL
                        @endif
                    @else
