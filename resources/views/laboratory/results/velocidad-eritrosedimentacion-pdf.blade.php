...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Velocidad de Eritrosedimentación' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">HEMATOLOGÍA</td>
                <td></td>
                <td></td>
            </tr>
            @php
                $resultado = $results->firstWhere('parametro', 'Velocidad de Eritrosedimentación');
                $unidad = $resultado ? ($resultado->unidad_medida ?? 'mm/h') : 'mm/h';
                ...
                $rangoHombres = $valoresRef['hombres']['rango'] ?? '0 a 15 mm/h';
                $rangoMujeres = $valoresRef['mujeres']['rango'] ?? '0 a 20 mm/h';
            @endphp

            <tr>
                <td class="exam-name">Velocidad de Eritrosedimentación:</td>
