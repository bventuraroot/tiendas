...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Antígenos Helicobacter pylori' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
    ...
    <table class="results-table">
        ...
        <tbody>
            ...
            @php
                ...
                $valorReferencia = $result ? $result->valor_referencia : ($valoresReferencia['valores_referencia']['rango'] ?? 'Negativo / Positivo');
            @endphp
            
            <tr>
                <td class="exam-name">Antígenos Helicobacter pylori:</td>
