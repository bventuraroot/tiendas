...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Ferritina' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">PROTEINAS NEOPLASICAS</td>
                <td></td>
                <td></td>
            </tr>
            @php
            ...
            <tr>
                <td class="exam-name">Ferritina:</td>
                ...
                <td class="reference-range">
                    Hasta 1 años: 12 a 327 ng/mL<br>
                    1 a 6 años: 4 a 67 ng/mL<br><br>
                    7 a 12 años<br>
                    Niñas: 7 a 84 ng/mL<br>
                    Niños: 14 a 124 ng/mL<br><br>
                    13 a 17 años<br>
                    Niñas: 13 a 68 ng/mL<br>
                    Niños: 14 a 152 ng/mL<br><br>
                    Mujeres: 13 a 150 ng/mL<br>
                    Hombres: 30 a 400 ng/mL
                </td>
            </tr>
        </tbody>
    </table>
