...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Deshidrogenasa Láctica (DHL)(LDH)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
        ...
        .reference-range {
            background-color: #c6efce; /* verde suave como en otros formatos */
        }
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">ENZIMAS</td>
                <td></td>
                <td></td>
            </tr>
            @php
            ...
            <tr>
                <td class="exam-name">Deshidrogenasa Láctica (DHL)(LDH) :</td>
