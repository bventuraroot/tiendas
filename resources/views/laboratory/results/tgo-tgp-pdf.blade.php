...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'TGO Y TGP' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    @php
        ...
        $valRef = config('lab_exam_templates.tgo_tgp.valores_referencia', []);
        $resultsByParam = $results->keyBy('parametro');

        $params = [
            ['key' => 'tgo', 'label' => 'Transaminasa Glutámico Oxalacética (TGO)', 'unidad' => 'U/L'],
            ['key' => 'tgp', 'label' => 'Transaminasa Glutámico Pirúvica (TGP)', 'unidad' => 'U/L'],
        ];
