...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Antígeno Prostático Específico Total (PSA)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    <table class="results-table">
        ...
        <tbody>
            <tr>
                <td class="exam-category">{{ $valoresReferencia['categoria'] ?? 'PROTEINAS NEOPLASICAS' }}</td>
                <td></td>
                <td></td>
            </tr>
            @php
                ...
                $valorReferencia = $result ? $result->valor_referencia : ($valoresReferencia['valores_referencia']['rango'] ?? implode("\n", [
            ...
            <tr>
                <td class="exam-name">Antígeno Prostático Específico Total (PSA):</td>
