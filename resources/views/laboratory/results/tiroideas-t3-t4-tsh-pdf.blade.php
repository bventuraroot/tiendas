...
<head>
    <meta charset="UTF-8">
    <title>Resultado de Examen - {{ $exam->nombre ?? 'Pruebas Tiroideas (T3, T4, TSH)' }}</title>
    <style>
        @page {
            margin: 1.5cm;
            size: Letter;
...
<body>
    ...
    @php
        ...
        $valRef = config('lab_exam_templates.tiroideas_t3_t4_tsh.valores_referencia', []);
        $resultsByParam = $results->keyBy('parametro');

        $params = [
            ['key' => 't3', 'label' => 'Triyodotironina (T3)', 'unidad' => 'ng/mL'],
            ['key' => 't4', 'label' => 'Tiroxina (T4)', 'unidad' => 'nmol/L'],
